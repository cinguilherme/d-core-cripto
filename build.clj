...
(def lib 'org.clojars.cinguilherme/d-core-cripto)
  ...
  (let [version (current-version)
    ...
    (b/write-pom {:class-dir class-dir
                  ...
                  [[:licenses
                   ...
                   [:scm
                    [:url "https://github.com/cinguilherme/d-core-cripto"]
                    [:connection "scm:git:https://github.com/cinguilherme/d-core-cripto.git"]
                    [:developerConnection "scm:git:ssh://git@github.com/cinguilherme/d-core-cripto.git"]]
                   [:developers
                    [:developer
                     [:id "cinguilherme"]
